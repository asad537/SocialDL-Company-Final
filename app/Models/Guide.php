        ...
        foreach ($data['blocks'] as $block) {
            switch ($block['type']) {
                case 'header':
                    ...
                    $html .= "<h{$level} style='font-weight:800; color:#0F172A; margin: 2rem 0 1rem; line-height:1.3;'>" . $block['data']['text'] . "</h{$level}>";
                    break;
                case 'paragraph':
                    $html .= "<p style='font-size:1rem; color:#334155; line-height:1.8; margin-bottom:1.5rem;'>" . $block['data']['text'] . "</p>";
                    break;
                case 'list':
