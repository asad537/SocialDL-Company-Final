...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .blog-img:hover{transform:scale(1.1);}
        .blog-title{font-weight:700;color:#fff;font-size:0.95rem;line-height:1.4;}
        .blog-meta{font-size:0.78rem;color:rgba(255,255,255,0.3);margin-top:4px;font-family:monospace;}
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            <h1><i class="fas fa-blog" style="color:#FFB800;margin-right:0.5rem;"></i> Blog Management</h1>
            <div class="breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a> / Blogs</div>
        </div>
