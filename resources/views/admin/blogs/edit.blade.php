...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div class="breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a> / <a href="{{ route('admin.blogs.index') }}">Blogs</a> / Edit</div>
        </div>
        ...
        <form id="blogForm" method="POST" action="{{ route('admin.blogs.update', $blog->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="video_url" value="{{ $blog->video_url }}">
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags_cloud" value="{{ $blog->tags_cloud }}">
                    </div>
                </div>
            </div>
