...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.blogs.index') }}" class="nav-item active"><i class="fas fa-blog"></i> Blogs</a>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div class="breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a> / <a href="{{ route('admin.blogs.index') }}">Blogs</a> / Create</div>
        </div>
        <a href="{{ route('admin.blogs.index') }}" class="btn-back"><i class="fas fa-arrow-left"></i> Back to List</a>
    </div>
    ...
    document.getElementById('blogForm').onsubmit = async function(e) {
        ...
        try {
            if (blogEditor) {
                ...
                // Let's stick to JSON for now as our renderContent() in Blog model handles JSON.
