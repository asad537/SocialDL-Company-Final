...
@section('header_title', 'Create New Guide')

@section('breadcrumb')
    / <a href="{{ route('admin.guides.index') }}">Guides</a> / Create
@endsection
...
@push('styles')
    ...
    <style>
        ...
        #editor::-webkit-scrollbar-track { background: #f1f5f9; border-radius: 0 12px 12px 0; }
