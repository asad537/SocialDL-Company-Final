...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            <h1><i class="fas fa-plus" style="color:#FFB800;margin-right:0.5rem;"></i> Add New Platform</h1>
            ...
            <div class="form-card">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="h1" placeholder="e.g. Download Facebook Videos & Audios">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select name="status">
