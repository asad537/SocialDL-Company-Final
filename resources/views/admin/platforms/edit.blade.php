...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div class="breadcrumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a> / <a href="{{ route('admin.platforms.index') }}">Platforms</a> / Edit</div>
        </div>
        <div style="display:flex;gap:1rem;">
            <a href="{{ route('platforms.show', $platform->slug) }}" target="_blank" class="btn-back" style="background:rgba(255,184,0,0.1);color:#FFB800;border-color:rgba(255,184,0,0.2);"><i class="fas fa-eye"></i> View Live Page</a>
